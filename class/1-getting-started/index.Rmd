...
## `r fa('globe')` Everything you need will be on the course website:<br>https://eda.seas.gwu.edu/2025-Fall/

--

## `r fa('calendar')` The [schedule](https://emse-eda-gwu.github.io/2025-Fall/schedule.html) is the best starting point
...
## 1) `r fa("book")` Weekly Homework / Readings: [HW1](https://eda.seas.gwu.edu/2025-Fall/hw/1-tidy-data.html)
...
## 3) `r fa("pen-ruler")` [Final Project](https://eda.seas.gwu.edu/2025-Fall/project/0-overview.html) 
...
<center>
<img src="https://eda.seas.gwu.edu/2025-Fall/figs/grade-breakdown-1.png" width=90%>
</center>
...
## `r fa('slack')` Use [Slack](https://emse-eda-f25.slack.com/) to ask questions.
...
# `r fa('hard-drive')` [Course Software](https://eda.seas.gwu.edu/2025-Fall/software.html)

--

## `r fa('slack')` [Slack](https://emse-eda-f25.slack.com/): **turn notifications on**!
...
1. If you haven't already, install everything on the [software page](https://eda.seas.gwu.edu/2025-Fall/software.html)
