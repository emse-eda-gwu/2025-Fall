...
- ["Beware Spurious Correlations", Harvard Business Review](https://hbr.org/2015/06/beware-spurious-correlations) (if you don't have a subscription to see it, a backed up version can be found [here](https://github.com/emse-eda-gwu/2025-Fall/raw/main/content/beware-spurious-correlations.pdf)).
...
- View the course site [help page](https://eda.seas.gwu.edu/2025-Fall/references.html#choosing-the-right-chart) on choosing the right chart.
